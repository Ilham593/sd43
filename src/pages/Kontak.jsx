    ...
    <div className="pb-20 space-y-12 sm:space-y-20">
      ...
      <section className="max-w-3xl px-4 pt-10 mx-auto space-y-4 text-center">
        ...
        <p className="text-lg leading-relaxed text-gray-500">
          Kami siap melayani kebutuhan informasi Anda seputar pendidikan dan
          administrasi di{" "}
      ...
      <div className="grid grid-cols-1 gap-8 px-4 mx-auto lg:grid-cols-5 max-w-7xl">
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <a
            ...
            className="block group" // group digunakan untuk efek hover bersamaan
          >
            <div className="p-6 bg-blue-600 rounded-[32px] text-white flex items-center justify-between shadow-xl shadow-blue-200 transition-all duration-300 hover:shadow-blue-400 hover:-translate-y-1">
              <div>
                <p className="text-[10px] font-black tracking-[0.2em] uppercase opacity-70 mb-1">
                  Update Harian
                </p>
              ...
              <div className="p-3 transition-all bg-white/20 group-hover:bg-white/40 rounded-2xl group-hover:rotate-12">
          ...
          <div className="absolute items-start hidden gap-3 p-4 border shadow-xl bottom-6 left-6 right-6 lg:left-auto lg:right-6 lg:w-72 bg-white/90 backdrop-blur-md rounded-2xl border-white/50 sm:flex">
            ...
            <div>
              ...
              <p className="mt-1 text-xs font-bold leading-tight text-gray-800">
                Klik untuk navigasi via Google Maps
              </p>
            </div>
          </div>
        </div>
...
function ContactItem({ icon, label, value, isLink }) {
  const content = (
    <div className="flex items-start gap-4 p-3 -m-3 transition-colors rounded-2xl hover:bg-gray-50 group/item">
      ...
      <div>
        ...
        <p
          className={`text-sm sm:text-base font-bold text-gray-700 leading-snug ${isLink ? "text-blue-600" : ""}`}
        >
          {value}
        </p>
      </div>
  ...
  return isLink ? (
    <a
      href={isLink}
      target={isLink.startsWith("http") ? "_blank" : "_self"}
      rel="noreferrer"
    >
      {content}
    </a>
