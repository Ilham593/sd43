...
function Galeri() {
  return (
    <div className="pb-20 space-y-12 sm:space-y-16">
        ...
        <div className="relative z-10 flex flex-col justify-between gap-6 md:flex-row md:items-center">
          <div className="space-y-4">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight sm:text-5xl">
              Galeri{" "}
              <span className="font-serif italic font-light tracking-normal text-blue-400">
                Kegiatan
              </span>
            </h1>
            <p className="max-w-xl text-sm leading-relaxed text-gray-400 sm:text-lg">
              Melihat kembali momen-momen berharga, kreativitas siswa, dan
              semangat belajar di
              <span className="font-semibold text-white">
                {" "}
                SDN 43 Kota Bengkulu.
              </span>
            </p>
          </div>
                ...
                <div className="space-y-3 transition-transform duration-500 translate-y-8 group-hover:translate-y-0">
                  ...
                  <div className="flex items-center gap-4 text-xs font-medium text-white/70">
                    <span className="flex items-center gap-1">
                      <HiSearchCircle size={16} className="text-blue-400" />{" "}
                      Lihat Detail
                    </span>
                    <span className="flex items-center gap-1">
                      <HiExternalLink size={16} className="text-blue-400" />{" "}
                      Share
                    </span>
                  </div>
                </div>
      ...
      <section className="py-12 px-6 text-center bg-blue-50 rounded-[40px] border-2 border-dashed border-blue-200 transition-all hover:border-blue-400 group">
        <div className="flex justify-center mb-4 text-blue-600 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6">
          <FaInstagram size={48} />
        </div>

        <h3 className="text-2xl font-black tracking-tight text-blue-900">
          Ingin melihat lebih banyak momen?
        </h3>

        <p className="max-w-sm mx-auto mt-2 text-sm font-medium text-blue-600/70">
          Ikuti media sosial resmi kami untuk update kegiatan harian, prestasi
          siswa, dan keseruan di sekolah.
        </p>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-8 py-4 mt-8 font-black text-white transition-all bg-blue-600 shadow-xl rounded-2xl shadow-blue-200 hover:bg-blue-700 hover:shadow-blue-400 active:scale-95"
        >
          <FaInstagram size={20} />
          Kunjungi Instagram
        </a>
